...
engine = pyttsx3.init()
engine.setProperty('rate', 190)  # Set the speaking rate
...
# Function to search Google using Brave browser
def search_google(query):
    """Search Google using Brave browser."""
